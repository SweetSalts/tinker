...
public class CloudGameApi {
     ...
     */
    public void startGame(String gameCode, String clientSession, final IServerSessionListener listener) {
     ...
     * 请求业务后台，停止游戏(释放云端实例)
     */
    public void stopGame(String gameCode) {
        String bodyString = mGson.toJson(new GameStopParam(gameCode, mUserID));
